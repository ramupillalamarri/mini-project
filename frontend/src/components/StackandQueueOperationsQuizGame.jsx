...
import { Award, CheckCircle2, XCircle, ArrowRight, HelpCircle, RefreshCw } from 'lucide-react';
...
export default function StackandQueueOperationsQuizGame({ onGameComplete }) {
  ...
  return (
    <div className="min-h-[500px] w-full max-w-3xl mx-auto bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-2xl border border-indigo-500/20 p-6 sm:p-8 text-white shadow-2xl relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex justify-between items-center border-b border-indigo-500/20 pb-4 mb-6">
        <div>
          <h2 className="text-xl font-bold tracking-tight text-indigo-200">Stack and Queue Operations Quiz</h2>
          <p className="text-xs text-indigo-400/80 mt-1">Local Template Fallback Mode</p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6 py-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400 max-w-sm">
              You completed the quiz with a final score of <span className="text-indigo-400 font-bold">{score}</span> points.
            </p>
          </div>
          <button
            onClick={restartGame}
